#ifndef __EC_CODE_TIMER_H
#define __EC_CODE_TIMER_H
...
typedef BasicProfiler<default_logging_policy, default_stats_policy, HighResolutionTimer> profiler;   

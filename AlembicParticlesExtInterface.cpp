...
//		Tab<Point3>& speed
//			speed per vertex in world coordinates
bool IAlembicParticlesExt::GetMultipleRenderMeshVertexSpeed(TimeValue t, INode *inode, View& view, int meshNumber, Tab<Point3>& speed) { 
...
void IAlembicParticlesExt::GetUpdateInterval(TimeValue& start, TimeValue& finish) { 
...
int IAlembicParticlesExt::NumParticlesGenerated() { return IAlembicParticlesExt::NumParticles(); }
...
void IAlembicParticlesExt::SetParticleLifeSpanByIndex(int index, TimeValue LifeSpan) {  
	ESS_LOG_WARNING("IAlembicParticlesExt::GetParticleLifeSpanByBornIndex not implmented.");
}
void IAlembicParticlesExt::SetParticleLifeSpanByBornIndex(int id, TimeValue LifeSpan) { 
...
void IAlembicParticlesExt::SetParticleGroupTimeByIndex(int index, TimeValue time) { 
	ESS_LOG_WARNING("IAlembicParticlesExt::SetParticleGroupTimeByIndex not implmented.");
}
void IAlembicParticlesExt::SetParticleGroupTimeByBornIndex(int id, TimeValue time) {
...
void IAlembicParticlesExt::SetParticleOrientationByIndex(int index, Point3 orient) {
	ESS_LOG_WARNING("IAlembicParticlesExt::SetParticleOrientationByIndex not implmented.");
}
void IAlembicParticlesExt::SetParticleOrientationByBornIndex(int id, Point3 orient) {

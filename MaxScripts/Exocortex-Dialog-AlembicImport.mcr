...
rollout AlembicImportSettings "Alembic Import Settings" width:288 height:244
(
    local filename

	GroupBox geoGroup "Geometry" pos:[8,8] width:272 height:212
	...
	button importButton "Import" pos:[16,212] width:64 height:24
	button cancelButton "Cancel" pos:[208,212] width:64 height:24
    ...
    dropdownList objectDuplication "Object Duplication" pos:[48,168] width:200 height:40 items:#("Copy", "Instance", "Reference") selection:1

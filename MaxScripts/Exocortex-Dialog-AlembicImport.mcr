...
rollout AlembicImportSettings "Alembic Import Settings" width:288 height:204
(
    local filename

	GroupBox geoGroup "Geometry" pos:[8,8] width:272 height:172
	...
	button importButton "Import" pos:[16,172] width:64 height:24
	button cancelButton "Cancel" pos:[208,172] width:64 height:24

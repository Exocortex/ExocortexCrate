...
static const char* OBJ_TYPES[] = {"AbcGeom_Xform_v1",
                                  "AbcGeom_Camera_v1",
                                  "AbcGeom_PolyMesh_v3",
                                  "AbcGeom_SubD_v3",
                                  "AbcGeom_Curve_v1",
...
static const char* PRO_TYPES[] = {
    "bool",     "uchar",    "char",     "uint16",   "int16",    "uint32",
    "int32",    "uint64",   "int64",    "half",     "float",    "double",
    "string",   "wstring",  "vector2s", "vector2i", "vector2f", "vector2d",
    "vector3s", "vector3i", "vector3f", "vector3d", "point2s",  "point2i",
    "point2f",  "point2d",  "point3s",  "point3i",  "point3f",  "point3d",
    "box2s",    "box2i",    "box2f",    "box2d",    "box3s",    "box3i",
    "box3f",    "box3d",    "matrix3f", "matrix3d", "matrix4f", "matrix4d",
...
static PyMethodDef extension_methods[] = {
    {"getVersion", (PyCFunction)extension_getVersion, METH_NOARGS,
     "Returns the version number of the alembic extension"},
    {"getAlembicVersion", (PyCFunction)extension_getVersion, METH_NOARGS,
     "Returns the Alembic.IO version number used for the extension"},
    {"getIArchive", (PyCFunction)iArchive_new, METH_VARARGS,
     "Takes in a filename to an Alembic file, and returns an iArchive linked "
     "to that file."},
    {"getOArchive", (PyCFunction)oArchive_new, METH_VARARGS,
     "Takes in a filename to create an Alembic file at, and return an oArchive "
     "linked to that file."},

    {"getObjectTypes", (PyCFunction)extension_getObjectTypes, METH_NOARGS,
     "Returns a list of all valid object types. The same one listed in "
     "Appendix A."},
    {"getPropertyTypes", (PyCFunction)extension_getPropertyTypes, METH_NOARGS,
     "Returns a list of all valid property types. The same one listed in "
     "Appendix B."},
    {"createTimeSampling", (PyCFunction)TimeSampling_new, METH_VARARGS,
     "Returns a new Time Sampling"},
    {NULL, NULL}};

static PyMethodDef unlicensed_extension_methods[] = {{NULL, NULL}};
...
{
  PyObject* m =
      Py_InitModule3("_ExocortexAlembicPython", extension_methods,
                     "This is the core extension module. It provides access to "
                     "input as well as output archive objects.");

...
#define _CHECK_MODULO_NUMBER_ITEMS_(modulo)                            \
  if (nbItems % modulo) {                                              \
    std::string error;                                                 \
    error.append(                                                      \
        "Incorrect number of sample items, should be a multiple of "); \
    error.append(#modulo);                                             \
    error.append("!");                                                 \
    PyErr_SetString(getError(), error.c_str());                        \
    return NULL;                                                       \
...
#define _COPY_TUPLE_TO_VALUE_(ctype, format, expected)                         \
  ...
  for (size_t i = 0; i < expected; i++) {                                      \
    ...
    if (!PyArg_Parse(item, format, &tupleVec[i])) {                            \
      std::string error;                                                       \
      error.append(                                                            \
          "Some item of the sample tuple is not of the right type, should be " \
          "'");                                                                \
      error.append(#ctype);                                                    \
      error.append("'!");                                                      \
      PyErr_SetString(getError(), error.c_str());                              \
...
#define _COPY_TUPLE_TO_VECTOR_AND_CONVERT_(stype, ctype, ptype, format, \
                                           modulo)                      \
...
static PyObject *oProperty_setValues(PyObject *self, PyObject *args)
{
  ...
  if (prop->mIsArray) {
    ...
    /*if(numSamples >=
    prop->mBaseArrayProperty->getTimeSampling()->getNumStoredTimes())
    {
       printf("\n\tNumber of samples: %d\n\tExpected number: %d\n", numSamples,
    prop->mBaseArrayProperty->getTimeSampling()->getNumStoredTimes());
       PyErr_SetString(getError(), "Already stored the maximum number of
    samples!");
       return NULL;
    }*/
  }
    ...
    /*if(numSamples >=
    prop->mBaseScalarProperty->getTimeSampling()->getNumStoredTimes())
    {
       printf("\n\tNumber of samples: %d\n\tExpected number: %d\n", numSamples,
    prop->mBaseArrayProperty->getTimeSampling()->getNumStoredTimes());
       PyErr_SetString(getError(), "Already stored the maximum number of
  ...
  switch (prop->mPropType) {
    case propertyTP_boolean: {
      _COPY_TUPLE_TO_VALUE_(unsigned char, "i",
                            prop->intent);  // cannot use bool, because it would
                                            // create a bit-train
    ...
    case propertyTP_v2s: {
      ...
      prop->mV2sProperty->set(
          Imath::V2s((short)tupleVec[0], (short)tupleVec[1]));
      break;
    }
    case propertyTP_v2i: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 2);
    ...
    case propertyTP_v3s: {
      ...
      prop->mV3sProperty->set(Imath::V3s((short)tupleVec[0], (short)tupleVec[1],
                                         (short)tupleVec[2]));
      break;
    }
    case propertyTP_v3i: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 3);
      prop->mV3iProperty->set(
          Imath::V3i(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_v3f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 3);
      prop->mV3fProperty->set(
          Imath::V3f(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_v3d: {
      _COPY_TUPLE_TO_VALUE_(double, "d", 3);
      prop->mV3dProperty->set(
          Imath::V3d(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_p2s: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 2);
      prop->mP2sProperty->set(
          Imath::V2s((short)tupleVec[0], (short)tupleVec[1]));
      break;
    }
    case propertyTP_p2i: {
    ...
    case propertyTP_p3s: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 3);
      prop->mP3sProperty->set(Imath::V3s((short)tupleVec[0], (short)tupleVec[1],
                                         (short)tupleVec[2]));
      break;
    }
    case propertyTP_p3i: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 3);
      prop->mP3iProperty->set(
          Imath::V3i(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_p3f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 3);
      prop->mP3fProperty->set(
          Imath::V3f(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_p3d: {
      _COPY_TUPLE_TO_VALUE_(double, "d", 3);
      prop->mP3dProperty->set(
          Imath::V3d(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_box2s: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 4);
      prop->mBox2sProperty->set(
          Imath::Box2s(Imath::V2s((short)tupleVec[0], (short)tupleVec[1]),
                       Imath::V2s((short)tupleVec[2], (short)tupleVec[3])));
      break;
    }
    case propertyTP_box2i: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 4);
      prop->mBox2iProperty->set(
          Imath::Box2i(Imath::V2i(tupleVec[0], tupleVec[1]),
                       Imath::V2i(tupleVec[2], tupleVec[3])));
      break;
    }
    case propertyTP_box2f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 4);
      prop->mBox2fProperty->set(
          Imath::Box2f(Imath::V2f(tupleVec[0], tupleVec[1]),
                       Imath::V2f(tupleVec[2], tupleVec[3])));
      break;
    }
    case propertyTP_box2d: {
      _COPY_TUPLE_TO_VALUE_(double, "d", 4);
      prop->mBox2dProperty->set(
          Imath::Box2d(Imath::V2d(tupleVec[0], tupleVec[1]),
                       Imath::V2d(tupleVec[2], tupleVec[3])));
      break;
    }
    case propertyTP_box3s: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 6);
      prop->mBox3sProperty->set(
          Imath::Box3s(Imath::V3s((short)tupleVec[0], (short)tupleVec[1],
                                  (short)tupleVec[2]),
                       Imath::V3s((short)tupleVec[3], (short)tupleVec[4],
                                  (short)tupleVec[5])));
      break;
    }
    case propertyTP_box3i: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 6);
      prop->mBox3iProperty->set(
          Imath::Box3i(Imath::V3i(tupleVec[0], tupleVec[1], tupleVec[2]),
                       Imath::V3i(tupleVec[3], tupleVec[4], tupleVec[5])));
      break;
    }
    case propertyTP_box3f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 6);
      prop->mBox3fProperty->set(
          Imath::Box3f(Imath::V3f(tupleVec[0], tupleVec[1], tupleVec[2]),
                       Imath::V3f(tupleVec[3], tupleVec[4], tupleVec[5])));
      break;
    }
    case propertyTP_box3d: {
      _COPY_TUPLE_TO_VALUE_(double, "d", 6);
      prop->mBox3dProperty->set(
          Imath::Box3d(Imath::V3d(tupleVec[0], tupleVec[1], tupleVec[2]),
                       Imath::V3d(tupleVec[3], tupleVec[4], tupleVec[5])));
      break;
    }
    case propertyTP_m33f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 9);
      prop->mM33fProperty->set(Imath::M33f(
          tupleVec[0], tupleVec[1], tupleVec[2], tupleVec[3], tupleVec[4],
          tupleVec[5], tupleVec[6], tupleVec[7], tupleVec[8]));
      break;
    }
    case propertyTP_m33d: {
      _COPY_TUPLE_TO_VALUE_(double, "d", 9);
      prop->mM33dProperty->set(Imath::M33d(
          tupleVec[0], tupleVec[1], tupleVec[2], tupleVec[3], tupleVec[4],
          tupleVec[5], tupleVec[6], tupleVec[7], tupleVec[8]));
      break;
    }
    case propertyTP_m44f: {
      ...
      prop->mM44fProperty->set(
          Imath::M44f(tupleVec[0], tupleVec[1], tupleVec[2], tupleVec[3],
                      tupleVec[4], tupleVec[5], tupleVec[6], tupleVec[7],
                      tupleVec[8], tupleVec[9], tupleVec[10], tupleVec[11],
                      tupleVec[12], tupleVec[13], tupleVec[14], tupleVec[15]));
      break;
    }
    case propertyTP_m44d: {
      _COPY_TUPLE_TO_VALUE_(double, "d", 16);
      prop->mM44dProperty->set(
          Imath::M44d(tupleVec[0], tupleVec[1], tupleVec[2], tupleVec[3],
                      tupleVec[4], tupleVec[5], tupleVec[6], tupleVec[7],
                      tupleVec[8], tupleVec[9], tupleVec[10], tupleVec[11],
                      tupleVec[12], tupleVec[13], tupleVec[14], tupleVec[15]));
      break;
    ...
    case propertyTP_quatf: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 4);
      prop->mQuatfProperty->set(Imath::Quatf(
          tupleVec[0], Imath::V3f(tupleVec[1], tupleVec[2], tupleVec[3])));
      break;
    }
    case propertyTP_quatd: {
      _COPY_TUPLE_TO_VALUE_(double, "d", 4);
      prop->mQuatdProperty->set(Imath::Quatd(
          tupleVec[0], Imath::V3d(tupleVec[1], tupleVec[2], tupleVec[3])));
      break;
    }
    case propertyTP_c3h: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 3);
      prop->mC3hProperty->set(
          Imath::C3h((half)tupleVec[0], (half)tupleVec[1], (half)tupleVec[2]));
      break;
    }
    case propertyTP_c3f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 3);
      prop->mC3fProperty->set(
          Imath::C3f(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_c3c: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 3);
      prop->mC3cProperty->set(Imath::C3c((unsigned char)tupleVec[0],
                                         (unsigned char)tupleVec[1],
                                         (unsigned char)tupleVec[2]));
      break;
    }
    case propertyTP_c4h: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 4);
      prop->mC4hProperty->set(Imath::C4h((half)tupleVec[0], (half)tupleVec[1],
                                         (half)tupleVec[2], (half)tupleVec[3]));
      break;
    }
    case propertyTP_c4f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 4);
      prop->mC4fProperty->set(
          Imath::C4f(tupleVec[0], tupleVec[1], tupleVec[2], tupleVec[3]));
      break;
    }
    case propertyTP_c4c: {
      _COPY_TUPLE_TO_VALUE_(int, "i", 4);
      prop->mC4cProperty->set(
          Imath::C4c((unsigned char)tupleVec[0], (unsigned char)tupleVec[1],
                     (unsigned char)tupleVec[2], (unsigned char)tupleVec[3]));
      break;
    }
    case propertyTP_n2f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 2);
    ...
    case propertyTP_n3f: {
      _COPY_TUPLE_TO_VALUE_(float, "f", 3);
      prop->mN3fProperty->set(
          Imath::V3f(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_n3d: {
      _COPY_TUPLE_TO_VALUE_(double, "d", 3);
      prop->mN3dProperty->set(
          Imath::V3d(tupleVec[0], tupleVec[1], tupleVec[2]));
      break;
    }
    case propertyTP_boolean_array: {
      ...
      for (size_t i = 0; i < nbItems; i++) values[i] = tupleVec[i] > 0;
      Abc::OBoolArrayProperty::sample_type sample;
      if (values.size() > 0)
        sample = Abc::OBoolArrayProperty::sample_type(&values.front(),
                                                      values.size());
    ...
    case propertyTP_uchar_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OUcharArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_char_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OCharArrayProperty::sample_type(&values.front(),
                                                      values.size());
    ...
    case propertyTP_uint32_array: {
      _COPY_TUPLE_TO_VECTOR_(Alembic::Util::ALEMBIC_VERSION_NS::uint32_t,
                             unsigned long, "k", 1);
    ...
    case propertyTP_int32_array: {
      _COPY_TUPLE_TO_VECTOR_(Alembic::Util::ALEMBIC_VERSION_NS::int32_t, long,
                             "l", 1);
    ...
    case propertyTP_wstring_array: {
      ...
      for (size_t i = 0; i < nbItems; i++) values[i] = tupleVec[i];
      Abc::OWstringArrayProperty::sample_type sample;
      if (values.size() > 0)
        sample = Abc::OWstringArrayProperty::sample_type(&values.front(),
                                                         values.size());
    ...
    case propertyTP_v2s_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OV2sArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_v2i_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OV2iArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_v2f_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OV2fArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_v2d_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OV2dArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_v3s_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OV3sArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_v3i_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OV3iArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_v3f_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OV3fArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_v3d_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OV3dArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_p2s_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OP2sArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_p2i_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OP2iArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_p2f_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OP2fArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_p2d_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OP2dArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_p3s_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OP3sArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_p3i_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OP3iArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_p3f_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OP3fArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_p3d_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OP3dArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_box2s_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OBox2sArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_box2i_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OBox2iArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_box2f_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OBox2fArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_box2d_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OBox2dArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_box3s_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OBox3sArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_box3i_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OBox3iArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_box3f_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OBox3fArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_box3d_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OBox3dArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_m33f_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OM33fArrayProperty::sample_type(&values.front(),
                                                      values.size());
    ...
    case propertyTP_m33d_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OM33dArrayProperty::sample_type(&values.front(),
                                                      values.size());
    ...
    case propertyTP_m44f_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OM44fArrayProperty::sample_type(&values.front(),
                                                      values.size());
    ...
    case propertyTP_m44d_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OM44dArrayProperty::sample_type(&values.front(),
                                                      values.size());
    ...
    case propertyTP_quatf_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OQuatfArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_quatd_array: {
      ...
      if (values.size() > 0)
        sample = Abc::OQuatdArrayProperty::sample_type(&values.front(),
                                                       values.size());
    ...
    case propertyTP_c3h_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OC3hArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_c3f_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OC3fArrayProperty::sample_type(&values.front(), values.size());
      prop->mC3fArrayProperty->set(sample);
      break;
    }
    case propertyTP_c3c_array: {
      _COPY_TUPLE_TO_VECTOR_AND_CONVERT_(Imath::C3c, unsigned char, int, "i",
                                         3);
      Abc::OC3cArrayProperty::sample_type sample;
      if (values.size() > 0)
        sample =
            Abc::OC3cArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_c4h_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OC4hArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_c4f_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::OC4fArrayProperty::sample_type(&values.front(), values.size());
      prop->mC4fArrayProperty->set(sample);
      break;
    }
    case propertyTP_c4c_array: {
      _COPY_TUPLE_TO_VECTOR_AND_CONVERT_(Imath::C4c, unsigned char, int, "i",
                                         4);
      Abc::OC4cArrayProperty::sample_type sample;
      if (values.size() > 0)
        sample =
            Abc::OC4cArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_n2f_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::ON2fArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_n2d_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::ON2dArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_n3f_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::ON3fArrayProperty::sample_type(&values.front(), values.size());
    ...
    case propertyTP_n3d_array: {
      ...
      if (values.size() > 0)
        sample =
            Abc::ON3dArrayProperty::sample_type(&values.front(), values.size());
      prop->mN3dArrayProperty->set(sample);
      break;
    }
    default: {
      PyErr_SetString(getError(),
                      "Unsupported property type for setting values.");
      return NULL;
    }
  }
...
static PyMethodDef oProperty_methods[] = {
    ...
    {"setValues", (PyCFunction)oProperty_setValues, METH_VARARGS,
     "Appends a new sample to the property, given the values provided. The "
     "values have to be a flat list of components, matching the count of the "
     "property. For example if this is a vector3farray property the tuple has "
     "to contain a multiple of 3 float values."},
    {"isCompound", (PyCFunction)oProperty_isCompound, METH_NOARGS,
     "To distinguish between an oProperty and an oCompoundProperty, always "
     "returns false for oProperty."},
    {NULL, NULL}};
...
{
  ALEMBIC_TRY_STATEMENT
  if (prop->mBaseScalarProperty == NULL) return;
  ...
  switch (prop->mPropType) {
    case propertyTP_boolean: {
      delete (prop->mBoolProperty);
      break;
    }
    case propertyTP_uchar: {
      delete (prop->mUcharProperty);
      break;
    }
    case propertyTP_char: {
      delete (prop->mCharProperty);
      break;
    }
    case propertyTP_uint16: {
      delete (prop->mUInt16Property);
      break;
    }
    case propertyTP_int16: {
      delete (prop->mInt16Property);
      break;
    }
    case propertyTP_uint32: {
      delete (prop->mUInt32Property);
      break;
    }
    case propertyTP_int32: {
      delete (prop->mInt32Property);
      break;
    }
    case propertyTP_uint64: {
      delete (prop->mUInt64Property);
      break;
    }
    case propertyTP_int64: {
      delete (prop->mInt64Property);
      break;
    }
    case propertyTP_half: {
      delete (prop->mHalfProperty);
      break;
    }
    case propertyTP_float: {
      delete (prop->mFloatProperty);
      break;
    }
    case propertyTP_double: {
      delete (prop->mDoubleProperty);
      break;
    }
    case propertyTP_string: {
      delete (prop->mStringProperty);
      break;
    }
    case propertyTP_wstring: {
      delete (prop->mWstringProperty);
      break;
    }
    case propertyTP_v2s: {
      delete (prop->mV2sProperty);
      break;
    }
    case propertyTP_v2i: {
      delete (prop->mV2iProperty);
      break;
    }
    case propertyTP_v2f: {
      delete (prop->mV2fProperty);
      break;
    }
    case propertyTP_v2d: {
      delete (prop->mV2dProperty);
      break;
    }
    case propertyTP_v3s: {
      delete (prop->mV3sProperty);
      break;
    }
    case propertyTP_v3i: {
      delete (prop->mV3iProperty);
      break;
    }
    case propertyTP_v3f: {
      delete (prop->mV3fProperty);
      break;
    }
    case propertyTP_v3d: {
      delete (prop->mV3dProperty);
      break;
    }
    case propertyTP_p2s: {
      delete (prop->mP2sProperty);
      break;
    }
    case propertyTP_p2i: {
      delete (prop->mP2iProperty);
      break;
    }
    case propertyTP_p2f: {
      delete (prop->mP2fProperty);
      break;
    }
    case propertyTP_p2d: {
      delete (prop->mP2dProperty);
      break;
    }
    case propertyTP_p3s: {
      delete (prop->mP3sProperty);
      break;
    }
    case propertyTP_p3i: {
      delete (prop->mP3iProperty);
      break;
    }
    case propertyTP_p3f: {
      delete (prop->mP3fProperty);
      break;
    }
    case propertyTP_p3d: {
      delete (prop->mP3dProperty);
      break;
    }
    case propertyTP_box2s: {
      delete (prop->mBox2sProperty);
      break;
    }
    case propertyTP_box2i: {
      delete (prop->mBox2iProperty);
      break;
    }
    case propertyTP_box2f: {
      delete (prop->mBox2fProperty);
      break;
    }
    case propertyTP_box2d: {
      delete (prop->mBox2dProperty);
      break;
    }
    case propertyTP_box3s: {
      delete (prop->mBox3sProperty);
      break;
    }
    case propertyTP_box3i: {
      delete (prop->mBox3iProperty);
      break;
    }
    case propertyTP_box3f: {
      delete (prop->mBox3fProperty);
      break;
    }
    case propertyTP_box3d: {
      delete (prop->mBox3dProperty);
      break;
    }
    case propertyTP_m33f: {
      delete (prop->mM33fProperty);
      break;
    }
    case propertyTP_m33d: {
      delete (prop->mM33dProperty);
      break;
    }
    case propertyTP_m44f: {
      delete (prop->mM44fProperty);
      break;
    }
    case propertyTP_m44d: {
      delete (prop->mM44dProperty);
      break;
    }
    case propertyTP_quatf: {
      delete (prop->mQuatfProperty);
      break;
    }
    case propertyTP_quatd: {
      delete (prop->mQuatdProperty);
      break;
    }
    case propertyTP_c3h: {
      delete (prop->mC3hProperty);
      break;
    }
    case propertyTP_c3f: {
      delete (prop->mC3fProperty);
      break;
    }
    case propertyTP_c3c: {
      delete (prop->mC3cProperty);
      break;
    }
    case propertyTP_c4h: {
      delete (prop->mC4hProperty);
      break;
    }
    case propertyTP_c4f: {
      delete (prop->mC4fProperty);
      break;
    }
    case propertyTP_c4c: {
      delete (prop->mC4cProperty);
      break;
    }
    case propertyTP_n2f: {
      delete (prop->mN2fProperty);
      break;
    }
    case propertyTP_n2d: {
      delete (prop->mN2dProperty);
      break;
    }
    case propertyTP_n3f: {
      delete (prop->mN3fProperty);
      break;
    }
    case propertyTP_n3d: {
      delete (prop->mN3dProperty);
      break;
    }
    case propertyTP_boolean_array: {
      delete (prop->mBoolArrayProperty);
      break;
    }
    case propertyTP_uchar_array: {
      delete (prop->mUcharArrayProperty);
      break;
    }
    case propertyTP_char_array: {
      delete (prop->mCharArrayProperty);
      break;
    }
    case propertyTP_uint16_array: {
      delete (prop->mUInt16ArrayProperty);
      break;
    }
    case propertyTP_int16_array: {
      delete (prop->mInt16ArrayProperty);
      break;
    }
    case propertyTP_uint32_array: {
      delete (prop->mUInt32ArrayProperty);
      break;
    }
    case propertyTP_int32_array: {
      delete (prop->mInt32ArrayProperty);
      break;
    }
    case propertyTP_uint64_array: {
      delete (prop->mUInt64ArrayProperty);
      break;
    }
    case propertyTP_int64_array: {
      delete (prop->mInt64ArrayProperty);
      break;
    }
    case propertyTP_half_array: {
      delete (prop->mHalfArrayProperty);
      break;
    }
    case propertyTP_float_array: {
      delete (prop->mFloatArrayProperty);
      break;
    }
    case propertyTP_double_array: {
      delete (prop->mDoubleArrayProperty);
      break;
    }
    case propertyTP_string_array: {
      delete (prop->mStringArrayProperty);
      break;
    }
    case propertyTP_wstring_array: {
      delete (prop->mWstringArrayProperty);
      break;
    }
    case propertyTP_v2s_array: {
      delete (prop->mV2sArrayProperty);
      break;
    }
    case propertyTP_v2i_array: {
      delete (prop->mV2iArrayProperty);
      break;
    }
    case propertyTP_v2f_array: {
      delete (prop->mV2fArrayProperty);
      break;
    }
    case propertyTP_v2d_array: {
      delete (prop->mV2dArrayProperty);
      break;
    }
    case propertyTP_v3s_array: {
      delete (prop->mV3sArrayProperty);
      break;
    }
    case propertyTP_v3i_array: {
      delete (prop->mV3iArrayProperty);
      break;
    }
    case propertyTP_v3f_array: {
      delete (prop->mV3fArrayProperty);
      break;
    }
    case propertyTP_v3d_array: {
      delete (prop->mV3dArrayProperty);
      break;
    }
    case propertyTP_p2s_array: {
      delete (prop->mP2sArrayProperty);
      break;
    }
    case propertyTP_p2i_array: {
      delete (prop->mP2iArrayProperty);
      break;
    }
    case propertyTP_p2f_array: {
      delete (prop->mP2fArrayProperty);
      break;
    }
    case propertyTP_p2d_array: {
      delete (prop->mP2dArrayProperty);
      break;
    }
    case propertyTP_p3s_array: {
      delete (prop->mP3sArrayProperty);
      break;
    }
    case propertyTP_p3i_array: {
      delete (prop->mP3iArrayProperty);
      break;
    }
    case propertyTP_p3f_array: {
      delete (prop->mP3fArrayProperty);
      break;
    }
    case propertyTP_p3d_array: {
      delete (prop->mP3dArrayProperty);
      break;
    }
    case propertyTP_box2s_array: {
      delete (prop->mBox2sArrayProperty);
      break;
    }
    case propertyTP_box2i_array: {
      delete (prop->mBox2iArrayProperty);
      break;
    }
    case propertyTP_box2f_array: {
      delete (prop->mBox2fArrayProperty);
      break;
    }
    case propertyTP_box2d_array: {
      delete (prop->mBox2dArrayProperty);
      break;
    }
    case propertyTP_box3s_array: {
      delete (prop->mBox3sArrayProperty);
      break;
    }
    case propertyTP_box3i_array: {
      delete (prop->mBox3iArrayProperty);
      break;
    }
    case propertyTP_box3f_array: {
      delete (prop->mBox3fArrayProperty);
      break;
    }
    case propertyTP_box3d_array: {
      delete (prop->mBox3dArrayProperty);
      break;
    }
    case propertyTP_m33f_array: {
      delete (prop->mM33fArrayProperty);
      break;
    }
    case propertyTP_m33d_array: {
      delete (prop->mM33dArrayProperty);
      break;
    }
    case propertyTP_m44f_array: {
      delete (prop->mM44fArrayProperty);
      break;
    }
    case propertyTP_m44d_array: {
      delete (prop->mM44dArrayProperty);
      break;
    }
    case propertyTP_quatf_array: {
      delete (prop->mQuatfArrayProperty);
      break;
    }
    case propertyTP_quatd_array: {
      delete (prop->mQuatdArrayProperty);
      break;
    }
    case propertyTP_c3h_array: {
      delete (prop->mC3hArrayProperty);
      break;
    }
    case propertyTP_c3f_array: {
      delete (prop->mC3fArrayProperty);
      break;
    }
    case propertyTP_c3c_array: {
      delete (prop->mC3cArrayProperty);
      break;
    }
    case propertyTP_c4h_array: {
      delete (prop->mC4hArrayProperty);
      break;
    }
    case propertyTP_c4f_array: {
      delete (prop->mC4fArrayProperty);
      break;
    }
    case propertyTP_c4c_array: {
      delete (prop->mC4cArrayProperty);
      break;
    }
    case propertyTP_n2f_array: {
      delete (prop->mN2fArrayProperty);
      break;
    }
    case propertyTP_n2d_array: {
      delete (prop->mN2dArrayProperty);
      break;
    }
    case propertyTP_n3f_array: {
      delete (prop->mN3fArrayProperty);
      break;
    }
    case propertyTP_n3d_array: {
      delete (prop->mN3dArrayProperty);
      break;
    }
    default:
      break;
...
#define _NEW_PROP_IMPL_(tp, base, singleprop, arrayprop, writer)          \
  if (prop->mIsArray) {                                                   \
    prop->mPropType =                                                     \
        (propertyTP)(tp - propertyTP_boolean + propertyTP_boolean_array); \
    prop->m##base##arrayprop = new Abc::O##base##arrayprop(               \
        prop->mBaseArrayProperty->getPtr(), Abc::kWrapExisting);          \
    prop->m##base##arrayprop->setTimeSampling(                            \
        archive->mArchive->getTimeSampling(tsIndex));                     \
  }                                                                       \
  else {                                                                  \
    prop->mPropType = tp;                                                 \
    prop->m##base##singleprop = new Abc::O##base##singleprop(             \
        prop->mBaseScalarProperty->getPtr(), Abc::kWrapExisting);         \
    prop->m##base##singleprop->setTimeSampling(                           \
        archive->mArchive->getTimeSampling(tsIndex));                     \
  }
#define _NEW_PROP_(tp, base) \
  _NEW_PROP_IMPL_(tp, base, Property, ArrayProperty, Writer)
#define _NEW_PROP_CASE_IMPL_(pod, tp, base, singleprop, arrayprop, writer) \
  case Abc::pod: {                                                         \
    _NEW_PROP_IMPL_(tp, base, singleprop, arrayprop, writer)               \
    break;                                                                 \
  }
#define _NEW_PROP_CASE_(pod, tp, base) \
  _NEW_PROP_CASE_IMPL_(pod, tp, base, Property, ArrayProperty, Writer)
  ...
  if (propType == str) {                                                    \
    if (prop->mIsArray) {                                                   \
      prop->mPropType =                                                     \
          (propertyTP)(tp - propertyTP_boolean + propertyTP_boolean_array); \
      prop->m##base##arrayprop = new Abc::O##base##arrayprop(               \
          compound, in_propName, compound.getMetaData(), tsIndex);          \
      prop->mBaseArrayProperty = new Abc::OArrayProperty(                   \
          prop->m##base##arrayprop->getPtr(), Abc::kWrapExisting);          \
    }                                                                       \
    else {                                                                  \
      prop->mPropType = tp;                                                 \
      prop->m##base##singleprop = new Abc::O##base##singleprop(             \
          compound, in_propName, compound.getMetaData(), tsIndex);          \
      prop->mBaseScalarProperty = new Abc::OScalarProperty(                 \
          prop->m##base##singleprop->getPtr(), Abc::kWrapExisting);         \
    }                                                                       \
  }
#define _IF_CREATE_PROP_(tp, base, str) \
  _IF_CREATE_PROP_IMPL_(tp, base, str, Property, ArrayProperty)
                        ...
                        char *in_propType, int tsIndex, void *in_Archive)
{
  ...
  // check if it's an iCompoundProperty, they shouldn't have similar names to
  // avoid confusion when reading it!
  {
  ...
  // NEW check for intent! and assign it if necessary
  {
    ...
    if (i_pos != string::npos) {
      string sz_intent =
          propType.substr(i_pos + 1, propType.length() - i_pos - 2);
      ...
      // INFO_MSG("propType = " << propType << " with intent = " <<
      // (prop->intent));
    }
    else
      prop->intent = 1;
  ...
  Abc::CompoundPropertyWriterPtr compoundWriter =
      GetCompoundPropertyWriterPtr(compound);  // this variable is unused!
  ...
  if (propHeader != NULL) {
    ...
    if (baseProp.isCompound()) {
      ...
      PyObject_FREE(prop);
      return oCompoundProperty_new(compound, compoundFullName, in_propName,
                                   tsIndex, in_Archive);
    }
    else if (baseProp.isArray()) {
      prop->mIsArray = true;
      prop->mBaseArrayProperty = new Abc::OArrayProperty(
          baseProp.getPtr()->asArrayPtr(), Alembic::Abc::kWrapExisting);
      interpretation =
          prop->mBaseArrayProperty->getMetaData().get("interpretation");
    }
    else {
      prop->mIsArray = false;
      prop->mBaseScalarProperty = new Abc::OScalarProperty(
          baseProp.getPtr()->asScalarPtr(), Alembic::Abc::kWrapExisting);
      interpretation =
          prop->mBaseScalarProperty->getMetaData().get("interpretation");
    }
    ...
    if (propType.length() > 5) {
      ...
      if (prop->mIsArray) propType = propType.substr(0, propType.length() - 5);
    }
    else
      prop->mIsArray = false;
    ...
    else _IF_CREATE_PROP_(
        propertyTP_uchar, Uchar,
        "uchar") else _IF_CREATE_PROP_(propertyTP_char, Char,
                                       "char") else _IF_CREATE_PROP_(propertyTP_uint16,
                                                                     UInt16,
                                                                     "uint1"
                                                                     "6") else _IF_CREATE_PROP_(propertyTP_int16,
                                                                                                Int16,
                                                                                                "int16") else _IF_CREATE_PROP_(propertyTP_uint32,
                                                                                                                               UInt32,
                                                                                                                               "uint32") else _IF_CREATE_PROP_(propertyTP_int32,
                                                                                                                                                               Int32,
                                                                                                                                                               "int32") else _IF_CREATE_PROP_(propertyTP_uint64,
                                                                                                                                                                                              UInt64,
                                                                                                                                                                                              "uint64") else _IF_CREATE_PROP_(propertyTP_int64,
                                                                                                                                                                                                                              Int64,
                                                                                                                                                                                                                              "int64") else _IF_CREATE_PROP_(propertyTP_half,
                                                                                                                                                                                                                                                             Half,
                                                                                                                                                                                                                                                             "half") else _IF_CREATE_PROP_(propertyTP_float,
                                                                                                                                                                                                                                                                                           Float,
                                                                                                                                                                                                                                                                                           "float") else _IF_CREATE_PROP_(propertyTP_double,
                                                                                                                                                                                                                                                                                                                          Double,
                                                                                                                                                                                                                                                                                                                          "double") else _IF_CREATE_PROP_(propertyTP_string,
                                                                                                                                                                                                                                                                                                                                                          String,
                                                                                                                                                                                                                                                                                                                                                          "string") else _IF_CREATE_PROP_(propertyTP_wstring,
                                                                                                                                                                                                                                                                                                                                                                                          Wstring,
                                                                                                                                                                                                                                                                                                                                                                                          "wstring") else _IF_CREATE_PROP_(propertyTP_v2s,
                                                                                                                                                                                                                                                                                                                                                                                                                           V2s,
                                                                                                                                                                                                                                                                                                                                                                                                                           "vector2s") else _IF_CREATE_PROP_(propertyTP_v2i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                             V2i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                             "vector2i") else _IF_CREATE_PROP_(propertyTP_v2f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               V2f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "vector2f") else _IF_CREATE_PROP_(propertyTP_v2d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 V2d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "vector2d") else _IF_CREATE_PROP_(propertyTP_v3s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   V3s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "vector3s") else _IF_CREATE_PROP_(propertyTP_v3i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     V3i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     "vector3i") else _IF_CREATE_PROP_(propertyTP_v3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       V3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "vector3f") else _IF_CREATE_PROP_(propertyTP_v3d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         V3d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         "vector3d") else _IF_CREATE_PROP_(propertyTP_p2s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           P2s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "point2s") else _IF_CREATE_PROP_(propertyTP_p2i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            P2i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            "point2i") else _IF_CREATE_PROP_(propertyTP_p2f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             P2f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             "point2f") else _IF_CREATE_PROP_(propertyTP_p2d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              P2d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              "point2d") else _IF_CREATE_PROP_(propertyTP_p3s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               P3s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "point3s") else _IF_CREATE_PROP_(propertyTP_p3i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                P3i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "point3i") else _IF_CREATE_PROP_(propertyTP_p3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 P3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "point3f") else _IF_CREATE_PROP_(propertyTP_p3d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  P3d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "point3d") else _IF_CREATE_PROP_(propertyTP_box2s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Box2s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "box2s") else _IF_CREATE_PROP_(propertyTP_box2i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Box2i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "box2i") else _IF_CREATE_PROP_(propertyTP_box2f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 Box2f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "box2f") else _IF_CREATE_PROP_(propertyTP_box2d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                Box2d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "box2d") else _IF_CREATE_PROP_(propertyTP_box3s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               Box3s,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "box3s") else _IF_CREATE_PROP_(propertyTP_box3i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Box3i,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              "box3i") else _IF_CREATE_PROP_(propertyTP_box3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             Box3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             "box3f") else _IF_CREATE_PROP_(propertyTP_box3d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Box3d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            "box3d") else _IF_CREATE_PROP_(propertyTP_m33f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           M33f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "matrix3f") else _IF_CREATE_PROP_(propertyTP_m33d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             M33d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             "matrix3d") else _IF_CREATE_PROP_(propertyTP_m44f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               M44f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               "matrix4f") else _IF_CREATE_PROP_(propertyTP_m44d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 M44d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "matrix4d") else _IF_CREATE_PROP_(propertyTP_quatf,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Quatf,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "quatf") else _IF_CREATE_PROP_(propertyTP_quatd,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Quatd,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "quatd") else _IF_CREATE_PROP_(propertyTP_c3h,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 C3h,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 "color3h") else _IF_CREATE_PROP_(propertyTP_c3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  C3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  "color3f") else _IF_CREATE_PROP_(propertyTP_c3c,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   C3c,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "color3c") else _IF_CREATE_PROP_(propertyTP_c4h,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    C4h,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    "color4h") else _IF_CREATE_PROP_(propertyTP_c4f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     C4f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     "color4f") else _IF_CREATE_PROP_(propertyTP_c4c,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      C4c,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "color4c") else _IF_CREATE_PROP_(propertyTP_n2f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       N2f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "normal2f") else _IF_CREATE_PROP_(propertyTP_n2d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         N2d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         "normal2d") else _IF_CREATE_PROP_(propertyTP_n3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           N3f,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           "normal3f") else _IF_CREATE_PROP_(propertyTP_n3d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             N3d,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             "normal3d") else
    {
      std::string error;

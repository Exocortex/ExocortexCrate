...
static PyObject *iXformProperty_getNbStoredSamples(PyObject *self,
                                                   PyObject *args)
{
  ALEMBIC_TRY_STATEMENT
  return Py_BuildValue(
      "I", (unsigned int)iXformProperty_getNbStoredSamples_func(self));
  ALEMBIC_PYOBJECT_CATCH_STATEMENT
}
...
static PyMethodDef iXformProperty_methods[] = {
    ...
    {"getNbStoredSamples", (PyCFunction)iXformProperty_getNbStoredSamples,
    ...
    {"isCompound", (PyCFunction)iXformProperty_isCompound, METH_NOARGS,
     "To distinguish between an iXformProperty and an iCompoundProperty, "
     "always returns false for iXformProperty."},
    {NULL, NULL}};
...
static PyTypeObject iXformProperty_Type = {
    ...
    "This is the input Xform property. It provides access to the Xform's data, "

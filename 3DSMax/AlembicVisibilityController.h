...
void AlembicImport_SetupVisControl(const std::string &file,
...
class AlembicVisibilityControllerClassDesc : public ClassDesc2 {
 public:
  ...
  {
    static const MSTR str(_T("Alembic Visibility"));
    return str;
  }
  ...
  void *Create(BOOL loading = FALSE) { return new AlembicVisibilityController; }
  const TCHAR *InternalName()
  {
    return _T("AlembicVisController");

...
//////////////////////////////////////////////////////////////////////////////////////////
// Import options struct containing the information necessary to fill the camera
// object
...
bool getCameraSampleVal(AbcG::ICamera& objCamera, SampleInfo& sampleInfo,
                        AbcG::CameraSample sample, std::string name,
                        double& sampleVal)
{
  ...
  if (boost::iequals(name, "horizontalFOV")) {
    double aperature =
        sample.getHorizontalAperture() * 10.0;  // convert from cm to mm
    ...
    double aperature =
        sample.getVerticalAperture() * 10.0;  // convert from cm to mm
    double focalLength = sample.getFocalLength();
    if (focalLength < 0.000001) {
      focalLength = 1.0;
    }

...
AlembicWriteJob *AlembicObject::GetCurrentJob() { return mJob; }
...
Abc::OObject AlembicObject::GetOParent() { return mOParent; }
int AlembicObject::GetNumSamples() { return mNumSamples; }
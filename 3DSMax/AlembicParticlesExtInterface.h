...
class IAlembicParticlesExt : public IParticleObjectExt {
 ...
 public:
  ...
  // Since particles may have different motion, the particle system should
  // supply speed information
  ...
  virtual bool GetRenderMeshVertexSpeed(TimeValue t, INode* inode, View& view,
                                        Tab<Point3>& speed);
  ...
  // For multiple render meshes, if it supports vertex speed for motion blur,
  ...
  //		Tab<Point3>& speed
  //			speed per vertex in world coordinates
  virtual bool GetMultipleRenderMeshVertexSpeed(TimeValue t, INode* inode,
                                                View& view, int meshNumber,
                                                Tab<Point3>& speed);

  // Implemented by the Plug-In.
  // This method is called so the particle system can update its state to
  // reflect
  ...
  // Implemented by the Plug-in
  // Use this method to retrieve time of the current update step. The update
  // time maybe unrelated to
  ...
  // Some of these particles may be dead or not born yet (indicated by
  // GetAge(..) method =-1).
  virtual int NumParticles();

  // Implemented by the Plug-In.
  // The method returns how many particles were born. Since particle systems
  // have
  ...
  // Implemented by the Plug-in
  // The following four methods modify amount of particles in the particle
  // system
  ...
  // present
  // in the particle system. The methods returns Particle Group node the
  // particle belongs to,
  ...
  // Implemented by the Plug-In.
  // The following four methods define "current" index or bornIndex. This index
  // is used
  ...
  // Implemented by the Plug-In.
  // The following six methods define lifespan of the specified particle.
  // Particle is specified by either its
  // index in the particle group or particle system, or by its born index
  // if no index is specified then the "current" index is used
  // Parameters:
  //		int id
  ...
  // Implemented by the Plug-In.
  // The following six methods define orientation of the specified particle in
  // the current state.
  // Particle is specified by either its index in the particle group or particle
  // system, or by its born index
  // if no index is specified then the "current" index is used
  ...
  //			axis defines rotation axis, angle defines rotation amount per
  //frame
  ...
  // Implemented by the Plug-In.
  // The following twelve methods define scale factor of the specified particle

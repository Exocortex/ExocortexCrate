...
{
  return &AlembicNurbsModifierDesc;
}
...
void AlembicNurbsModifier::ModifyObject(TimeValue t, ModContext &mc,
                                        ObjectState *os, INode *node)
{
  ...
  this->pblock->GetValue(AlembicNurbsModifier::ID_IDENTIFIER, t, strIdentifier,
                         interval);
  ...
  this->pblock->GetValue(AlembicNurbsModifier::ID_IGNORE_SUBFRAME_SAMPLES, t,
...
RefResult AlembicNurbsModifier::NotifyRefChanged(const Interval &changeInt,
...
{
#else
RefResult AlembicNurbsModifier::NotifyRefChanged(Interval changeInt,
                                                 RefTargetHandle hTarget,
                                                 PartID &partID,
                                                 RefMessage message)
{
...
void AlembicNurbsModifier::BeginEditParams(IObjParam *ip, ULONG flags,
                                           Animatable *prev)
{
  this->ip = ip;
  editMod = this;
...
void AlembicNurbsModifier::EndEditParams(IObjParam *ip, ULONG flags,
                                         Animatable *next)
{

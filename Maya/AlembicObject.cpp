...
Abc::OObject AlembicObject::GetParentObject() { return mMyParent; }
...
AlembicObjectDeformNode::AlembicObjectDeformNode()
{
  ...
  gRefIdMax++;
  gDeformNodes.insert(
      std::pair<unsigned int, AlembicObjectDeformNode*>(mRefId, this));
}
...
AlembicObjectEmitterNode::AlembicObjectEmitterNode()
{
  mRefId = gRefIdMax;
  gRefIdMax++;
  gEmitterNodes.insert(
      std::pair<unsigned int, AlembicObjectEmitterNode*>(mRefId, this));
}
...
AlembicObjectLocatorNode::AlembicObjectLocatorNode()
{
  mRefId = gRefIdMax;
  gRefIdMax++;
  gLocatorNodes.insert(
      std::pair<unsigned int, AlembicObjectLocatorNode*>(mRefId, this));
}

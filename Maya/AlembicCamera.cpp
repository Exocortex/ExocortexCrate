...
MObject AlembicCameraNode::mGeomParamsList;
MObject AlembicCameraNode::mUserAttrsList;
...
MStatus AlembicCameraNode::compute(const MPlug& plug, MDataBlock& dataBlock)
{
  ...
  {
    ESS_PROFILE_SCOPE("AlembicCameraNode::compute readProps");
...
bool AlembicCameraNode::setInternalValueInContext(const MPlug & plug,
...
MStatus AlembicCameraNode::setDependentsDirty(const MPlug &plugBeingDirtied,
